...
## 2.4. Milestone 4 - Other users & profiles (10%) --partially implementes
...
### 2.4.2. Follow --no unfollow unfortunately :o
...
## 2.5. Milestone 5 - Adding & updating content (10%) --not implemented
...
## 2.6. Milestone 6 - Challenge Components (`advanced`) (10%) -- Partially implemented
...
* Instead of pagination, users an infinitely scroll through results. For infinite scroll to be properly implemented you need to progressively load posts as you scroll. 
  (This is not challenging and easier than 2.3.4!)
...
## 2.7. Milestone 7 - Very Challenge Components (`advanced *= 2`) (5%) -- Sorry no time to do this :(
...
## 2.8. Bonus Marks (5%) --See Bonus.md
...
# Special Consideration means that I may submit this assignment on 8th of April 19:59:59

Your application has been assessed and special consideration has been granted. You have been granted an 
extension of 10 days for Assignment 2 and the revised due date is the 8/04/21. You are expected to submit 
this assessment at the same time as the previous due date (for example, if the assignment was due at 11:59pm, 
then it will be due at 11:59pm on the revised due date). If you would like to request further extension on this assessment, 
please send through any updated documentation via email to specialconsideration@unsw.edu.au. If you have any questions 
relating to your assessment, please contact your course convenor. If your circumstance/condition is ongoing, you may wish 
to contact the Equitable Learning Service (ELS) directly to see if they can provide support and have educational adjustments 
put in place to assist you in managing your condition and studies simultaneously. 
Please visit: https://student.unsw.edu.au/els.
